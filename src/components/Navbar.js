  ...
  return (
    <div className="collapse navbar-collapse justify-content-end">
      <ul className="navbar-nav">
        ...
        <li className="nav-item"><Link to="/" className="nav-link"><FontAwesomeIcon icon="sign-in-alt" />Sign in</Link></li>
        <li className="nav-item"><Link to="/" className="nav-link"><FontAwesomeIcon icon="sign-out-alt" />Sign out</Link></li>
      </ul>
    </div>
  )
}
